...
import SettingComponent from './partials/SettingComponent'
import MailSetting from './partials/MailSetting'
import PinSetting from './partials/PinSetting'
import ThemeSetting from './partials/ThemeSetting'
import PasswordSetting from './partials/PasswordSetting'
						...
						<Window theme={theme}>
							...
							<SettingComponent
								...
								description={
									user.mail
										? 'Your mail: '
										: 'Add mail to your account: '
								}
								setShowSetting={setShowMailSetting}
								showSetting={showMailSetting}
							>
								<CloseOnOuterClick
									setSomething={setShowMailSetting}
								>
									<MailSetting
										setShowMailSetting={setShowMailSetting}
									/>
								</CloseOnOuterClick>
							</SettingComponent>
							...
							>
								<CloseOnOuterClick
									setSomething={setShowPasswordSetting}
								>
									<PasswordSetting
										setShowPasswordSetting={
											setShowPasswordSetting
										}
									/>
								</CloseOnOuterClick>
							...
							>
								<CloseOnOuterClick
									setSomething={setShowPinSetting}
								>
									<PinSetting
										setShowPinSetting={setShowPinSetting}
									/>
								</CloseOnOuterClick>
							</SettingComponent>
